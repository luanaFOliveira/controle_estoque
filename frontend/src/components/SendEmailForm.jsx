...
export const SendEmailForm = ({ handleShowLogin, setErrorMessage, setOpenSnack }) => {
    ...
    const [isButtonDisabled, setButtonDisabled] = useState(initialCountdown < 5 * 60);
    ...
    return (<Container>
        ...
        <Box component="form" onSubmit={handleSubmit} sx={{mt: 2}}>
            ...
            {isButtonDisabled && <Typography variant="body2">Aguarde {Math.floor(countdown / 60)} minutos
                e {countdown % 60} segundos para poder reenviar o email. Agradecemos a paciência 😊</Typography>}
